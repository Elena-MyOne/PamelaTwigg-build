(() => {
  ...
  const p = {
        ...
        for (let e = 0; e < this.length; e += 1) {
          ...
          if ((!s && r.dom7Listeners ? (o = r.dom7Listeners[t]) : s && r.dom7LiveListeners && (o = r.dom7LiveListeners[t]), o && o.length))
            for (let e = o.length - 1; e >= 0; e -= 1) {
              const s = o[e];
              (i && s.listener === i) || (i && s.listener && s.listener.dom7proxy && s.listener.dom7proxy === i) ? (r.removeEventListener(t, s.proxyListener, n), o.splice(e, 1)) : i || (r.removeEventListener(t, s.proxyListener, n), o.splice(e, 1));
            }
        }
      }
      return this;
    ...
    is: function (e) {
      ...
      if (e.nodeType || e instanceof o) {
        for (a = e.nodeType ? [e] : e, l = 0; l < a.length; l += 1) if (a[l] === n) return !0;
        return !1;
      }
      return !1;
    },
    ...
    append: function (...e) {
      ...
      for (let i = 0; i < e.length; i += 1) {
        ...
        for (let e = 0; e < this.length; e += 1)
          ...
          } else if (t instanceof o) for (let s = 0; s < t.length; s += 1) this[e].appendChild(t[s]);
    ...
    prepend: function (e) {
      ...
      for (s = 0; s < this.length; s += 1)
        ...
        } else if (e instanceof o) for (n = 0; n < e.length; n += 1) this[s].insertBefore(e[n], this[s].childNodes[0]);
    ...
    for (let s = 1; s < arguments.length; s += 1) {
      ...
      if (null != i && !v(i)) {
        ...
        for (let t = 0, n = s.length; t < n; t += 1) {
          ...
          void 0 !== r && r.enumerable && (g(e[n]) && g(i[n]) ? (i[n].__swiper__ ? (e[n] = i[n]) : w(e[n], i[n])) : !g(e[n]) && g(i[n]) ? ((e[n] = {}), i[n].__swiper__ ? (e[n] = i[n]) : w(e[n], i[n])) : (e[n] = i[n]));
        }
      }
    }
    return e;
    ...
    L = {
      updateSize: function () {
        ...
        (t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : i[0].clientWidth),
          ...
          (0 === t && e.isHorizontal()) || (0 === s && e.isVertical()) || ((t = t - parseInt(i.css('padding-left') || 0, 10) - parseInt(i.css('padding-right') || 0, 10)), (s = s - parseInt(i.css('padding-top') || 0, 10) - parseInt(i.css('padding-bottom') || 0, 10)), Number.isNaN(t) && (t = 0), Number.isNaN(s) && (s = 0), Object.assign(e, { width: t, height: s, size: e.isHorizontal() ? t : s }));
      },
      updateSlides: function () {
        ...
        let S = i.spaceBetween,
          ...
          E = 0;
        if (void 0 === r) return;
        'string' == typeof S && S.indexOf('%') >= 0 && (S = (parseFloat(S.replace('%', '')) / 100) * r), (e.virtualSize = -S), o ? c.css({ marginLeft: '', marginBottom: '', marginTop: '' }) : c.css({ marginRight: '', marginBottom: '', marginTop: '' }), i.centeredSlides && i.cssMode && (T(e.wrapperEl, '--swiper-centered-offset-before', ''), T(e.wrapperEl, '--swiper-centered-offset-after', ''));
        ...
        for (let n = 0; n < u; n += 1) {
          ...
          if ((C && e.grid.updateSlide(n, o, u, t), 'none' !== o.css('display'))) {
            if ('auto' === i.slidesPerView) {
              ...
              if ((a && (o[0].style.transform = 'none'), l && (o[0].style.webkitTransform = 'none'), i.roundLengths)) x = e.isHorizontal() ? o.outerWidth(!0) : o.outerHeight(!0);
              else {
                const e = s(r, 'width'),
                  t = s(r, 'padding-left'),
                  i = s(r, 'padding-right'),
              ...
              a && (o[0].style.transform = a), l && (o[0].style.webkitTransform = l), i.roundLengths && (x = Math.floor(x));
            } else (x = (r - (i.slidesPerView - 1) * S) / i.slidesPerView), i.roundLengths && (x = Math.floor(x)), c[n] && (c[n].style[t('width')] = `${x}px`);
            c[n] && (c[n].swiperSlideSize = x),
              f.push(x),
              i.centeredSlides ? ((b = b + x / 2 + y / 2 + S), 0 === y && 0 !== n && (b = b - r / 2 - S), 0 === n && (b = b - r / 2 - S), Math.abs(b) < 0.001 && (b = 0), i.roundLengths && (b = Math.floor(b)), E % i.slidesPerGroup == 0 && p.push(b), h.push(b)) : (i.roundLengths && (b = Math.floor(b)), (E - Math.min(e.params.slidesPerGroupSkip, E)) % e.params.slidesPerGroup == 0 && p.push(b), h.push(b), (b = b + x + S)),
              (e.virtualSize += x + S),
              (y = x),
              (E += 1);
          }
        }
        if (((e.virtualSize = Math.max(e.virtualSize, r) + g), o && a && ('slide' === i.effect || 'coverflow' === i.effect) && n.css({ width: `${e.virtualSize + i.spaceBetween}px` }), i.setWrapperSize && n.css({ [t('width')]: `${e.virtualSize + i.spaceBetween}px` }), C && e.grid.updateWrapperSize(x, p, t), !i.centeredSlides)) {
          const t = [];
        ...
        if ((u !== d && e.emit('slidesLengthChange'), p.length !== v && (e.params.watchOverflow && e.checkOverflow(), e.emit('snapGridLengthChange')), h.length !== w && e.emit('slidesGridLengthChange'), i.watchSlidesProgress && e.updateSlidesOffset(), !(l || i.cssMode || ('slide' !== i.effect && 'fade' !== i.effect)))) {
      ...
      updateSlidesProgress: function (e) {
        ...
        for (let e = 0; e < i.length; e += 1) {
          ...
          const d = (o + (s.centeredSlides ? t.minTranslate() : 0) - l) / (a.swiperSlideSize + s.spaceBetween),
            c = (o - r[0] + (s.centeredSlides ? t.minTranslate() : 0) - l) / (a.swiperSlideSize + s.spaceBetween),
            u = -(o - l),
            p = u + t.slidesSizesGrid[e];
          ((u >= 0 && u < t.size - 1) || (p > 1 && p <= t.size) || (u <= 0 && p >= t.size)) && (t.visibleSlides.push(a), t.visibleSlidesIndexes.push(e), i.eq(e).addClass(s.slideVisibleClass)), (a.progress = n ? -d : d), (a.originalProgress = n ? -c : c);
        }
      ...
      updateProgress: function (e) {
        ...
        const a = r,
          l = o;
        0 === i ? ((n = 0), (r = !0), (o = !0)) : ((n = (e - t.minTranslate()) / i), (r = n <= 0), (o = n >= 1)), Object.assign(t, { progress: n, isBeginning: r, isEnd: o }), (s.watchSlidesProgress || (s.centeredSlides && s.autoHeight)) && t.updateSlidesProgress(e), r && !a && t.emit('reachBeginning toEdge'), o && !l && t.emit('reachEnd toEdge'), ((a && !r) || (l && !o)) && t.emit('fromEdge'), t.emit('progress', n);
      },
      ...
      updateActiveIndex: function (e) {
        ...
        Object.assign(t, { snapIndex: d, realIndex: u, previousIndex: o, activeIndex: c }), t.emit('activeIndexChange'), t.emit('snapIndexChange'), a !== u && t.emit('realIndexChange'), (t.initialized || t.params.runCallbacksOnInit) && t.emit('slideChange');
      },
  ...
  const k = {
      slideTo: function (e, t, s, i, n) {
        ...
        let o = e;
        o < 0 && (o = 0);
        const { params: a, snapGrid: l, slidesGrid: d, previousIndex: c, activeIndex: u, rtlTranslate: p, wrapperEl: h, enabled: f } = r;
        if ((r.animating && a.preventInteractionOnTransition) || (!f && !i && !n)) return !1;
        const m = Math.min(r.params.slidesPerGroupSkip, o);
        let g = m + Math.floor((o - m) / r.params.slidesPerGroup);
        g >= l.length && (g = l.length - 1), (u || a.initialSlide || 0) === (c || 0) && s && r.emit('beforeSlideChangeStart');
        const v = -l[g];
        ...
        let w;
        if (((w = o > u ? 'next' : o < u ? 'prev' : 'reset'), (p && -v === r.translate) || (!p && v === r.translate))) return r.updateActiveIndex(o), a.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), 'slide' !== a.effect && r.setTranslate(v), 'reset' !== w && (r.transitionStart(s, w), r.transitionEnd(s, w)), !1;
        if (a.cssMode) {
      ...
      slidePrev: function (e, t, s) {
        void 0 === e && (e = this.params.speed), void 0 === t && (t = !0);
        const i = this,
          { params: n, animating: r, snapGrid: o, slidesGrid: a, rtlTranslate: l, enabled: d } = i;
        if (!d) return i;
        if (n.loop) {
        ...
        let f = 0;
        if ((void 0 !== h && ((f = a.indexOf(h)), f < 0 && (f = i.activeIndex - 1), 'auto' === n.slidesPerView && 1 === n.slidesPerGroup && n.slidesPerGroupAuto && ((f = f - i.slidesPerViewDynamic('previous', !0) + 1), (f = Math.max(f, 0)))), n.rewind && i.isBeginning)) {
    ...
    P = {
      loopCreate: function () {
        ...
        'auto' !== s.slidesPerView || s.loopedSlides || (s.loopedSlides = o.length), (e.loopedSlides = Math.ceil(parseFloat(s.loopedSlides || s.slidesPerView, 10))), (e.loopedSlides += s.loopAdditionalSlides), e.loopedSlides > o.length && (e.loopedSlides = o.length);
        const a = [],
          l = [];
        o.each((t, s) => {
          const i = h(t);
          s < e.loopedSlides && l.push(t), s < o.length && s >= o.length - e.loopedSlides && a.push(t), i.attr('data-swiper-slide-index', s);
        });
      ...
      loopFix: function () {
        ...
        t < i ? ((l = s.length - 3 * i + t), (l += i), e.slideTo(l, 0, !1, !0) && 0 !== d && e.setTranslate((a ? -e.translate : e.translate) - d)) : t >= s.length - i && ((l = -s.length + t + i), (l += i), e.slideTo(l, 0, !1, !0) && 0 !== d && e.setTranslate((a ? -e.translate : e.translate) - d)), (e.allowSlidePrev = n), (e.allowSlideNext = r), e.emit('loopFix');
      },
  ...
  function A(e) {
    ...
    if ((Object.assign(o, { isTouched: !0, isMoved: !1, allowTouchCallbacks: !0, isScrolling: void 0, startMoving: void 0 }), (l.startX = g), (l.startY = v), (o.touchStartTime = m()), (t.allowClick = !0), t.updateSize(), (t.swipeDirection = void 0), a.threshold > 0 && (o.allowThresholdMove = !1), 'touchstart' !== c.type)) {
      let e = !0;
      u.is(o.focusableElements) && ((e = !1), 'SELECT' === u[0].nodeName && (o.isTouched = !1)), s.activeElement && h(s.activeElement).is(o.focusableElements) && s.activeElement !== u[0] && s.activeElement.blur();
  ...
  function O(e) {
    ...
    if (!s.allowTouchMove) return h(d.target).is(n.focusableElements) || (s.allowClick = !1), void (n.isTouched && (Object.assign(o, { startX: u, startY: p, currentX: u, currentY: p }), (n.touchStartTime = m())));
    if (n.isTouchEvent && r.touchReleaseOnEdges && !r.loop)
      if (s.isVertical()) {
        if ((p < o.startY && s.translate <= s.maxTranslate()) || (p > o.startY && s.translate >= s.minTranslate())) return (n.isTouched = !1), void (n.isMoved = !1);
    ...
    if (void 0 === n.isScrolling) {
      let e;
      (s.isHorizontal() && o.currentY === o.startY) || (s.isVertical() && o.currentX === o.startX) ? (n.isScrolling = !1) : f * f + g * g >= 25 && ((e = (180 * Math.atan2(Math.abs(g), Math.abs(f))) / Math.PI), (n.isScrolling = s.isHorizontal() ? e > r.touchAngle : 90 - e > r.touchAngle));
    }
    ...
    (s.allowClick = !1),
      ...
      n.isMoved || (r.loop && !r.cssMode && s.loopFix(), (n.startTranslate = s.getTranslate()), s.setTransition(0), s.animating && s.$wrapperEl.trigger('webkitTransitionEnd transitionend'), (n.allowMomentumBounce = !1), !r.grabCursor || (!0 !== s.allowSlideNext && !0 !== s.allowSlidePrev) || s.setGrabCursor(!0), s.emit('sliderFirstMove', d)),
      s.emit('sliderMove', d),
      (n.isMoved = !0);
    let v = s.isHorizontal() ? f : g;
    (o.diff = v), (v *= r.touchRatio), a && (v = -v), (s.swipeDirection = v > 0 ? 'prev' : 'next'), (n.currentTranslate = v + n.startTranslate);
    let w = !0,
      T = r.resistanceRatio;
    if (
      (r.touchReleaseOnEdges && (T = 0),
      v > 0 && n.currentTranslate > s.minTranslate() ? ((w = !1), r.resistance && (n.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + n.startTranslate + v) ** T)) : v < 0 && n.currentTranslate < s.maxTranslate() && ((w = !1), r.resistance && (n.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - n.startTranslate - v) ** T)),
  ...
  function _(e) {
    ...
    const w = (u - o[p]) / h,
      T = p < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup;
    if (c > i.longSwipesMs) {
      if (!i.longSwipes) return void t.slideTo(t.activeIndex);
      'next' === t.swipeDirection && (w >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? g : p + T) : t.slideTo(p)), 'prev' === t.swipeDirection && (w > 1 - i.longSwipesRatio ? t.slideTo(p + T) : null !== v && w < 0 && Math.abs(w) > i.longSwipesRatio ? t.slideTo(v) : t.slideTo(p));
    } else {
      if (!i.shortSwipes) return void t.slideTo(t.activeIndex);
      !t.navigation || (l.target !== t.navigation.nextEl && l.target !== t.navigation.prevEl) ? ('next' === t.swipeDirection && t.slideTo(null !== g ? g : p + T), 'prev' === t.swipeDirection && t.slideTo(null !== v ? v : p)) : l.target === t.navigation.nextEl ? t.slideTo(p + T) : t.slideTo(p);
    }
  }
  function $() {
    const e = this,
  ...
  const N = (e, t) => {
      const s = i(),
        { params: n, touchEvents: r, el: o, wrapperEl: a, device: l, support: d } = e,
        c = !!n.nested,
      ...
      } else o[u](r.start, e.onTouchStart, !1), s[u](r.move, e.onTouchMove, c), s[u](r.end, e.onTouchEnd, !1);
      (n.preventClicks || n.preventClicksPropagation) && o[u]('click', e.onClick, !0), n.cssMode && a[u]('scroll', e.onScroll), n.updateOnWindowResize ? e[p](l.ios || l.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', $, !0) : e[p]('observerUpdate', $, !0);
    },
    B = {
      attachEvents: function () {
        ...
        (e.onTouchStart = A.bind(e)), (e.onTouchMove = O.bind(e)), (e.onTouchEnd = _.bind(e)), s.cssMode && (e.onScroll = z.bind(e)), (e.onClick = I.bind(e)), n.touch && !D && (t.addEventListener('touchstart', G), (D = !0)), N(e, 'on');
      },
  ...
  const F = {
      ...
      translate: {
          ...
          let o = (function (e, t) {
            ...
            return (
              s.WebKitCSSMatrix
                ...
                : ((o = a.MozTransform || a.OTransform || a.MsTransform || a.msTransform || a.transform || a.getPropertyValue('transform').replace('translate(', 'matrix(1, 0, 0, 1,')), (i = o.toString().split(','))),
        ...
        setTranslate: function (e, t) {
          ...
          let l,
            d = 0,
            c = 0;
          s.isHorizontal() ? (d = i ? -e : e) : (c = e), n.roundLengths && ((d = Math.floor(d)), (c = Math.floor(c))), n.cssMode ? (o[s.isHorizontal() ? 'scrollLeft' : 'scrollTop'] = s.isHorizontal() ? -d : -c) : n.virtualTranslate || r.transform(`translate3d(${d}px, ${c}px, 0px)`), (s.previousTranslate = s.translate), (s.translate = s.isHorizontal() ? d : c);
      ...
      transition: {
        ...
        transitionStart: function (e, t) {
          ...
          const s = this,
            { params: i } = s;
          i.cssMode || (i.autoHeight && s.updateAutoHeight(), M({ swiper: s, runCallbacks: e, direction: t, step: 'Start' }));
        },
        transitionEnd: function (e, t) {
          void 0 === e && (e = !0);
          const s = this,
            { params: i } = s;
          (s.animating = !1), i.cssMode || (s.setTransition(0), M({ swiper: s, runCallbacks: e, direction: t, step: 'End' }));
        },
      },
      slide: k,
      loop: P,
      ...
      images: {
        loadImage: function (e, t, s, i, n, o) {
          ...
          h(e).parent('picture')[0] || (e.complete && n) ? d() : t ? ((l = new a.Image()), (l.onload = d), (l.onerror = d), i && (l.sizes = i), s && (l.srcset = s), t && (l.src = t)) : d();
        },
  ...
  class R {
    constructor() {
      ...
      if ((1 === i.length && i[0].constructor && 'Object' === Object.prototype.toString.call(i[0]).slice(8, -1) ? (t = i[0]) : ([e, t] = i), t || (t = {}), (t = w({}, t)), e && !t.el && (t.el = e), t.el && h(t.el).length > 1)) {
        const e = [];
        return (
          h(t.el).each((s) => {
            const i = w({}, t, { el: s });
          ...
          y ||
            (y = (function (e) {
              ...
              const p = o.match(/(iPod)(.*OS\s([\d_]+))?/),
                ...
                f = 'Win32' === n;
              let m = 'MacIntel' === n;
              return !u && m && s.touch && ['1024x1366', '1366x1024', '834x1194', '1194x834', '834x1112', '1112x834', '768x1024', '1024x768', '820x1180', '1180x820', '810x1080', '1080x810'].indexOf(`${l}x${d}`) >= 0 && ((u = o.match(/(Version)\/([\d.]+)/)), u || (u = [0, 1, '13_0_0']), (m = !1)), c && !f && ((a.os = 'android'), (a.android = !0)), (u || h || p) && ((a.os = 'ios'), (a.ios = !0)), a;
            })(a)),
          y)),
        (o.browser =
          (E ||
      ...
      const l = {};
      o.modules.forEach((e) => {
        e({ swiper: o, extendParams: V(t, l), on: o.on.bind(o), once: o.once.bind(o), off: o.off.bind(o), emit: o.emit.bind(o) });
      });
      const d = w({}, q, l);
      return (
        (o.params = w({}, d, W, t)),
        ...
        Object.assign(o, {
          ...
          touchEvents: (function () {
            ...
            return (o.touchEventsTouch = { start: e[0], move: e[1], end: e[2], cancel: e[3] }), (o.touchEventsDesktop = { start: t[0], move: t[1], end: t[2] }), o.support.touch || !o.params.simulateTouch ? o.touchEventsTouch : o.touchEventsDesktop;
          })(),
          touchEventsData: { isTouched: void 0, isMoved: void 0, allowTouchCallbacks: void 0, touchStartTime: void 0, isScrolling: void 0, currentTranslate: void 0, startTranslate: void 0, allowThresholdMove: void 0, focusableElements: o.params.focusableElements, lastClickTime: m(), clickTimeout: void 0, velocities: [], allowMomentumBounce: void 0, isTouchEvent: void 0, startMoving: void 0 },
          allowClick: !0,
    ...
    update() {
      ...
      s.breakpoints && e.setBreakpoint(),
        ...
        e.params.freeMode && e.params.freeMode.enabled ? (i(), e.params.autoHeight && e.updateAutoHeight()) : ((n = ('auto' === e.params.slidesPerView || e.params.slidesPerView > 1) && e.isEnd && !e.params.centeredSlides ? e.slideTo(e.slides.length - 1, 0, !1, !0) : e.slideTo(e.activeIndex, 0, !1, !0)), n || i()),
    ...
    destroy(e, t) {
      ...
      return (
        void 0 === s.params ||
          ...
          t && (s.removeClasses(), n.removeAttr('style'), r.removeAttr('style'), o && o.length && o.removeClass([i.slideVisibleClass, i.slideActiveClass, i.slideNextClass, i.slidePrevClass].join(' ')).removeAttr('style').removeAttr('data-swiper-slide-index')),
          s.emit('destroy'),
    ...
    R.use([
      function (e) {
        ...
        s('init', () => {
          ...
          s('destroy', () => {
            a && n.cancelAnimationFrame(a), o && o.unobserve && t.el && (o.unobserve(t.el), (o = null)), n.removeEventListener('resize', l), n.removeEventListener('orientationchange', d);
          });
      },
      function (e) {
        ...
        const o = [],
          ...
          l = function (e, t) {
            ...
            s.observe(e, { attributes: void 0 === t.attributes || t.attributes, childList: void 0 === t.childList || t.childList, characterData: void 0 === t.characterData || t.characterData }), o.push(s);
          };
  ...
  const X = document.querySelector('.header__burger'),
    ...
    K = document.querySelector('.header__list');
  (X.onclick = function () {
    X.classList.toggle('active'), U.classList.toggle('active'), document.body.classList.toggle('lock');
  }),
    K.addEventListener('click', function (e) {
      e.target.closest('.header__link') && (X.classList.remove('active'), U.classList.remove('active'), document.body.classList.remove('lock'));
    }),
    (document.querySelector('.scroll-up__body').onclick = function () {
      window.scrollTo(0, 0);
    });
  const J = document.querySelectorAll('.button a, .header__list li a');
  for (const e of J) e.addEventListener('click', Q);
  function Q(e) {
    if (!link.classList.contain('.header__social')) {
      e.preventDefault();
  ...
  const Z = document.querySelectorAll('._anim-items');
  if (Z.length > 0) {
    function e(e) {
      for (let e = 0; e < Z.length; e++) {
        const s = Z[e],
          ...
          n = t(s).top,
          r = 4;
        let o = window.innerHeight - i / r;
        i > window.innerHeight && (o = window.innerHeight - window.innerHeight / r), scrollY > n - o && scrollY < n + i ? s.classList.add('_active-scroll') : s.classList.contains('_anim-no-hide') || s.classList.remove('_active-scroll');
      }
    }
    function t(e) {
  ...
  let ee = document.querySelectorAll('._tabs');
  for (let e = 0; e < ee.length; e++) {
    ...
    for (let e = 0; e < s.length; e++) {
      ...
      t.addEventListener('click', function (n) {
        for (let e = 0; e < s.length; e++) s[e].classList.remove('_active'), i[e].classList.remove('_active');
        t.classList.add('_active'), i[e].classList.add('_active'), n.preventDefault();
      });
    }
  }
  document.addEventListener('DOMContentLoaded', function () {
    const e = document.getElementById('form'),
      t = document.querySelector('._errorMessageEmail'),
      s = document.querySelector('._errorMessageName');
    function i(e) {
    ...
    function o() {
      '' === e.elements.email.value && (t.innerHTML = 'Please enter the email field (www@www.com).');
    }
    e.addEventListener('submit', async function (a) {
      a.preventDefault();
      let l = (function (e) {
          let a = 0,
            l = document.querySelectorAll('._req');
          for (let e = 0; e < l.length; e++) {
            const t = l[e];
            n(t), t.classList.contains('_email') ? r(t) && (i(t), a++, o()) : (('checkbox' === t.getAttribute('type') && !1 === t.checked) || '' === t.value) && (i(t), a++);
          }
          return (s.innerHTML = ''), (t.innerHTML = ''), a;
        })(),
        d = new FormData(e);
      if (0 === l) {
        e.classList.add('_sending');
        let t = await fetch('sendform.php', { method: 'POST', body: d });
        t.ok
          ? (await t.json(),
            (function () {
              const e = document.querySelector('.success');
              function t() {
                e.classList.add('_hidden');
              }
              e.addEventListener('click', t), e.classList.remove('_hidden'), setTimeout(t, 3e3);
            })(),
            e.reset(),
          ...
          : (!(function () {
            ...
            e.classList.remove('_sending'));
      } else '' === e.elements.name.value && (s.innerHTML = 'Please enter the name field'), o();
    });
  });
  let te = document.querySelectorAll('._viewpass');
  ...
  let se = 0;
  null != document.querySelector('.slideshow') &&
    (function e() {
      const t = document.querySelectorAll('.mySlides');
      se++, se > t.length && (se = 1);
      for (let e = 0; e < t.length; e++) t[e].className = t[e].className.replace(' activeSlides', '');
      (t[se - 1].className += ' activeSlides'), setTimeout(e, 3e3);
    })(),
    (function (e) {
      var t,
        s,
        i = 'carousel__item',
        n = e.getElementsByClassName(i),
        r = n.length,
        o = 0,
        a = !0;
      function l(e) {
        if (!a) {
          ...
          var t = e - 1,
            ...
            o = e - 2,
            l = e + 2;
          r - 1 > 3 && (t <= 0 ? (o = r - 1) : s >= r - 1 && (l = 0), 0 === e ? ((t = r - 1), (o = r - 2), (l = e + 1)) : e === r - 1 && ((t = e - 1), (s = 0), (l = 1)), (n[o].className = i), (n[l].className = i), (n[t].className = 'carousel__item prev'), (n[e].className = 'carousel__item active'), (n[s].className = 'carousel__item next'));
        }
      }
      function d() {
        a || (o === r - 1 ? (o = 0) : o++, l(o));
      ...
      n[r - 1].classList.add('prev'), n[0].classList.add('active'), n[1].classList.add('next'), (t = e.getElementsByClassName('carousel__button--next')[0]), (s = e.getElementsByClassName('carousel__button--prev')[0]), t.addEventListener('click', d), s.addEventListener('click', c), (a = !1);
    })(document);
})();
